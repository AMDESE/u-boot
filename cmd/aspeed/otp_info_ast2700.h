...
static const struct otpkey_type a1_key_type[] = {
	...
	{3, CAL_MANU_PUB_HASH, "Manufacture public key hash for Caliptra used"},
	{4, CAL_OWN_PUB_HASH,  "Owner public key hash for Caliptra used"},
...
static const struct otpconf_info a1_conf_info[] = {
	...
	{ 0, 14, 1, 1, "User Area ECC enable" },
	{ 0, 14, 1, 0, "User Area ECC disable" },
	...
	{ 0, 10, 1, 1, "Enable Write Protect of OTP Hardware Revision ID bits" },
	{ 0, 10, 1, 0, "Disable Write Protect of OTP Hardware Revision ID bits" },
	{ 0, 9, 1, 1, "Enable Write Protect of OTP key retire bits" },
	{ 0, 9, 1, 0, "Disable Write Protect of OTP key retire bits" },
	...
	{ 2, 15, 1, 1, "Enable Secure Boot" },
	{ 2, 15, 1, 0, "Disable Secure Boot" },
	{ 2, 14, 1, 1, "Ignore Secure Boot hardware strap enable" },
	{ 2, 14, 1, 0, "Ignore Secure Boot hardware strap disable" },
	{ 2, 13, 1, 1, "Disable low security key #0" },
	{ 2, 13, 1, 0, "Enable low security key #0" },
	{ 2, 12, 1, 1, "Disable Caliptra cryptographic verfication" },
	{ 2, 12, 1, 0, "Enable Caliptra cryptographic verfication" },
	{ 2, 11, 1, 1, "Enable HW PUF program done" },
	{ 2, 11, 1, 0, "Disable HW PUF program done" },
	{ 2, 9, 2, OTP_REG_VALUE, "The Device Life Cycle State: 0x%x" },
	{ 2, 8, 1, 1, "Enable Boot ROM Message output through USB-Uart port x" },
	{ 2, 8, 1, 0, "Disable Boot ROM Message output through USB-Uart port x" },
	...
	{ 2, 6, 1, 1, "Enable eMMC software reset" },
	{ 2, 6, 1, 0, "Disable eMMC software reset" },
	{ 2, 5, 1, 1, "Disable Uart Message of Boot ROM" },
	{ 2, 5, 1, 0, "Enable Uart Message of Boot ROM" },
	{ 2, 4, 1, 1, "Disable Flash Strap" },
	{ 2, 4, 1, 0, "Enable Flash Strap" },
	...
	{ 5, 0, 10, OTP_REG_VALUE, "Pre OTP Patch code size: 0x%x" },
	...
	{ 8, 0, 16, OTP_REG_VALUE, "SoC Key Retire bits: 0x%x" },
	...
	{ 15, 0, 16, OTP_REG_VALUE, "Secure Boot Header Offset: 0x%x" },
	{ 16, 0, 16, OTP_REG_VALUE, "This will be source of DICE generation.: 0x%x" },
	{ 17, 0, 16, OTP_REG_VALUE, "This will be source of DICE generation.: 0x%x" },
	{ 18, 0, 16, OTP_REG_VALUE, "This will be source of DICE generation.: 0x%x" },
	{ 19, 0, 16, OTP_REG_VALUE, "This will be source of DICE generation.: 0x%x" },
	{ 20, 0, 16, OTP_REG_VALUE, "Hardware revision ID[15:0] (prevent rollback): 0x%x" },
	{ 21, 0, 16, OTP_REG_VALUE, "Hardware revision ID[31:16] (prevent rollback): 0x%x" },
	{ 22, 0, 16, OTP_REG_VALUE, "Hardware revision ID[47:32] (prevent rollback): 0x%x" },
	{ 23, 0, 16, OTP_REG_VALUE, "Hardware revision ID[63:48] (prevent rollback): 0x%x" },
	{ 24, 0, 16, OTP_REG_VALUE, "Internal bus timing setting0: 0x%x" },
	{ 25, 0, 16, OTP_REG_VALUE, "Internal bus timing setting1: 0x%x" },
	{ 26, 0, 16, OTP_REG_VALUE, "Internal bus timing setting2: 0x%x" },
	{ 27, 0, 16, OTP_REG_VALUE, "Internal bus timing setting3: 0x%x" },
	{ 28, 0, 16, OTP_REG_VALUE, "Internal bus timing setting4: 0x%x" },
	{ 29, 0, 16, OTP_REG_VALUE, "Internal bus timing setting5: 0x%x" },
	{ 30, 0, 16, OTP_REG_VALUE, "Internal bus timing setting6: 0x%x" },
	{ 31, 0, 16, OTP_REG_VALUE, "Internal bus timing setting7: 0x%x" },
};

static const struct otpstrap_info a1_strap_info[] = {
	{ 1, 1, 1, "Enable Boot from CPU die SPI" },
	{ 1, 1, 0, "Disable Boot from CPU die SPI" },
	...
	{ 10, 1, 1, "Disable SSP running." },
	{ 10, 1, 0, "Enable SSP running." },
	{ 11, 1, 1, "Disable TSP running." },
	{ 11, 1, 0, "Enable TSP running." },
	{ 12, 1, 1, "VGA linear memory size" },
	{ 12, 1, 0, "VGA linear memory size" },
	{ 13, 1, 1, "VGA linear memory size" },
	{ 13, 1, 0, "VGA linear memory size" },
	...
	{ 22, 1, 1, "Disable SoC FMC hash verify when secure boot is disabled" },
	{ 22, 1, 0, "Enable SoC FMC hash verify when secure boot is disabled" },
	...
	{ 27, 1, 1, "Recovery from Uart or USB selection" },
	{ 27, 1, 0, "Recovery from Uart or USB selection" },
	{ 28, 2, 0, "Boot from USB port selection" },
	{ 28, 2, 1, "Boot from USB port selection" },
	{ 28, 2, 2, "Boot from USB port selection" },
	{ 28, 2, 3, "Boot from USB port selection" },
};
...
static const struct otpstrap_ext_info a1_strap_ext_info[] = {
	...
	{ 51, 3, 0, "LTPI Max frequency" },
	{ 51, 3, 1, "LTPI Max frequency" },
	{ 51, 3, 2, "LTPI Max frequency" },
	{ 51, 3, 3, "LTPI Max frequency" },
	{ 51, 3, 4, "LTPI Max frequency" },
	{ 51, 3, 5, "LTPI Max frequency" },
	{ 51, 3, 6, "LTPI Max frequency" },
	{ 51, 3, 7, "LTPI Max frequency" },
	{ 54, 1, 1, "LTPI IO Type" },
	{ 54, 1, 0, "LTPI IO Type" },
...
static const struct otpcal_info a1_cal_info[] = {
	{ 0, 0, 16, OTP_REG_VALUE, "Manufacture pk key hash retire: 0x%x" },
	{ 1, 0, 16, OTP_REG_VALUE, "Owner pk key hash retire: 0x%x" },
	{ 2, 0, 1, 0, "Enable LMS verify" },
	{ 2, 0, 1, 1, "Disable LMS verify" },
	{ 3, 0, 32, OTP_REG_VALUE, "FMC SVN: 0x%x" },
	{ 5, 0, 128, OTP_REG_VALUE, "Runtime SVN: 0x%x" },
	{ 13, 0, 1, 0, "Anti-rollback disable" },
	{ 13, 0, 1, 1, "Anti-rollback enable" },
	{ 14, 0, 256, OTP_REG_VALUE, "Field Entropy: 0x%x" },
	{ 30, 0, 768, OTP_REG_VALUE, "IDEVID Cert attr: 0x%x" },
	{ 78, 0, 128, OTP_REG_VALUE, "IDEVID manuf HSM identifier: 0x%x" },
};
