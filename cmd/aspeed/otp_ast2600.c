...
static int do_otpcmp(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	phys_addr_t addr;
	int otp_addr = 0;
	int ret;
...
static int do_otpprotect(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 input;
	u32 bit_offset;
	u32 prog_address;
...
static int do_otp_scuprotect(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 scu_offset;
	u32 bit_offset;
	u32 conf_offset;
...
static int do_otpupdate(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 update_num;
	int force = 0;
	int ret;
...
static int do_otprid(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 otp_rid[2];
	u32 sw_rid[2];
	int rid_num = 0;
...
static int do_otpretire(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 retire_id;
	int force = 0;
	int ret;
...
static int do_otpverify(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	phys_addr_t addr;
	int ret;
...
static int do_otpinvalid(struct cmd_tbl *cmdtp, int flag, int argc, char *const argv[])
{
	u32 header_offset;
	int force = 0;
	int ret;
