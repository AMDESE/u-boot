...
static void ast2600_enable_uart_pinmux(struct ast2600_scu *scu, int uart_idx)
{
	switch (uart_idx) {
	case 1:
		scu->pinmux7 |= (BIT(7) | BIT(6));
		break;
	case 2:
		scu->pinmux7 |= (BIT(14) | BIT(15));
		break;
	case 3:
		scu->pinmux6 |= (BIT(28) | BIT(29));
		break;
	case 4:
		scu->pinmux4 |= (BIT(14) | BIT(15));
		break;
	case 5:
		/* do nothing*/
		break;
	case 6:
		scu->pinmux5 |= (BIT(16) | BIT(17));
		break;
	case 7:
		scu->pinmux5 |= (BIT(18) | BIT(19));
		break;
	case 8:
		scu->pinmux5 |= (BIT(20) | BIT(21));
		break;
	case 9:
		scu->pinmux5 |= (BIT(22) | BIT(23));
		break;
	case 10:
		scu->pinmux8 |= (BIT(20) | BIT(21));
		break;
	case 11:
		scu->pinmux8 |= (BIT(22) | BIT(23));
		break;
	case 12:
		scu->pinmux19 |= (BIT(0) | BIT(1));
		scu->pinmux6 &= ~(BIT(0) | BIT(1));
		break;
	case 13:
		scu->pinmux19 |= (BIT(2) | BIT(3));
		scu->pinmux6 &= ~(BIT(2) | BIT(3));
		break;
	default:
		break;
	}
...
static uint32_t ast2600_get_uart_clk_rate(struct ast2600_scu *scu, int uart_idx)
{
	...
	uint32_t hicr9 = readl(0x1e789098);
